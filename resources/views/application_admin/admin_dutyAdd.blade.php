    ...
    <div class="col-xs-10 col-lg-offset-1">
        ...
        <div class="ibox float-e-margins" style="margin-bottom:50px;">
            ...
            <div class="ibox-content">
                <!-- form began -->
                <form class="form-horizontal" action="/admin_duty" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">说明</label>
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" name="comment" id="comment" type="text" rows="8"></textarea>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
