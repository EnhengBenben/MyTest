    ...
    <div class="col-xs-10 col-lg-offset-1">
        ...
        <div class="ibox float-e-margins" style="margin-bottom:50px;">
            ...
            <div class="ibox-content">
                <!-- form began -->
                <form class="form-horizontal" action="/region/{{$region->id}}" method="post" role="form" enctype="multipart/form-data">
                    <input type="hidden" name="_method" value="PUT"/>
                    <input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}"/>
                    <div class="form-group"><label class="col-sm-2 control-label">地域</label>
                        <div class="col-sm-3"><input class="form-control" name="name" id="name" type="text" value="{{$region->name}}"></div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group"><label class="col-sm-2 control-label">积分</label>
                        <div class="col-sm-2">
                            <input class="form-control" type="text" name="score" id="score" value="{{$region->score}}"/>
                        </div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">说明</label>
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" name="comment" id="comment" type="text" rows="8">{{$region->comment}}</textarea>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
