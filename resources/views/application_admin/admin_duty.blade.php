    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="tabs-container">
                <button class="btn pull-right" style="background-color: #18a689;color: #FFFFFE" onclick="window.location.href='/admin_duty/add'">添加行政职务</button>
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="#">行政职务</a></li>
    ...
    <script>
        $(document).ready(function(){
            ...
            tableBody.on('click', 'button.edit', function () {
                ...
                var id = data['id'];
                window.location = '/admin_duty/edit/' + id;
            });
            /*var tableBody = $('.dataTable tbody');
