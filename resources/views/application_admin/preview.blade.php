...
<div style="margin-right: -15px">
    ...
    <table id="table3" cellpadding="0" cellspacing="0" class="table table-bordered" style="font-size: 14px;margin-left: -8px;margin-top: -21px;table-layout: fixed">
        <tr>
            ...
            <td colspan="5" style="vertical-align: middle">{{$course_name}}</td>
        </tr>
        <tr>
    ...
    <button class="btn hidden-print" style="margin-left: 30px;display: none" onclick="window.print()" type="button">打印申请表</button>
        </div>
</div>
