    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="tabs-container">
                <button class="btn pull-right" style="background-color: #18a689;color: #FFFFFE" onclick="window.location.href='/degree/add'">添加学位</button>
                <ul class="nav nav-tabs">
                    <li class=""><a href="/score/tech_duty">技术职称</a></li>
                    <li class="active"><a href="#">学历</a></li>
    ...
    <script>
        $(document).ready(function(){
            ...
            tableBody.on('click', 'button.edit', function () {
                ...
                var id = data['id'];
                window.location = '/degree/edit/' + id;
            });
            /*var tableBody = $('.dataTable tbody');
