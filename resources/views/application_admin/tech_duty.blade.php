    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="tabs-container">
                <button class="btn pull-right" style="background-color: #18a689;color: #FFFFFE" onclick="window.location.href='/tech_duty/add'">添加职称</button>
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#">技术职称</a></li>
                    <li class=""><a href="/score/degree">学历</a></li>
                    <li class=""><a href="/score/org_rank">医院级别</a></li>
                    <li class=""><a href="/score/admin_duty">行政职务</a></li>
                    <li class=""><a href="/score/region">地域</a></li>
    ...
    <script>
        $(document).ready(function(){
            ...
            tableBody.on('click', 'button.edit', function () {
                ...
                var id = data['id'];
                window.location = '/tech_duty/edit/' + id;
            });
            /*var tableBody = $('.dataTable tbody');
