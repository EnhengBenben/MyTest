    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="tabs-container">
                <button class="btn pull-right" style="background-color: #18a689;color: #FFFFFE" onclick="window.location.href='/org_rank/add'">添加医院级别</button>
                <ul class="nav nav-tabs">
                    <li class=""><a href="/score/tech_duty">技术职称</a></li>
                    <li class=""><a href="/score/degree">学历</a></li>
                    <li class="active"><a href="#">医院级别</a></li>
    ...
    <script>
        $(document).ready(function(){
            ...
            tableBody.on('click', 'button.edit', function () {
                ...
                var id = data['id'];
                window.location = '/org_rank/edit/' + id;
            });
            /*var tableBody = $('.dataTable tbody');
