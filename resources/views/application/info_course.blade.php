...
<div style="margin-right: -15px">
    ...
    <div class="table-box">
        <table id="table0" cellpadding="0" cellspacing="0" class="table table-bordered" style="font-size: 12px;margin-left: -8px">
            <tr>
                ...
                <td ><input required="" class="validate[required]" id="oce_info_name" name="name" size="20" type="text" value="{{\Input::old('name')}}"/></td>
                <td width="250">性别</td>
            ...
            <tr>
                ...
                <td>手机号码</td>
                <td colspan="3"><input required="" class="validate[required]" id="oce_info_idno" name="phone_number" size="25" type="text" value="{{\Input::old('phone_number')}}"/></td>
            </tr>
            <tr>
                <td >籍贯</td>
                ...
                <td>电子邮箱</td>
                <td colspan="3"><input required="" class="validate[required]" id="email" name="email" size="25" type="text" value="{{\Input::old('email')}}"/></td>
            </tr>
            <tr>
                <td style="word-wrap: break-word">身份证号码</td>
                <td colspan="5">
                    <input required="" class="validate[required]" id="id_num" name="id_no" size="45" type="text" value="{{\Input::old('id_no')}}"/>
                </td>
            </tr>
            <tr>
    ...
    <table id="table1" cellpadding="0" cellspacing="0" class="table table-bordered" style="font-size: 12px;margin-left: -8px">
        ...
        <tr>
            ...
            <td>从事专业</td>
            <td colspan="2">
                <input required="" class="validate[required]" id="major" name="speciality" size="40" style="cursor:pointer" type="text" value="{{\Input::old('speciality')}}"/>
            </td>
        </tr>
        <tr>
            <td>单位所在地域</td>
            ...
            <td>邮政编码</td>
            <td colspan="2">
            <input required="" class="validate[required]" id="zip_code" name="zip_code" size="40" type="text" value="{{\Input::old('zip_code')}}"/>
            </td>
        </tr>
        <tr>
            <td >单位通讯地址</td>
